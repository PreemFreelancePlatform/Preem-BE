...
public class User
    ...
    @OneToMany(mappedBy = "userprop",
            cascade = CascadeType.ALL,
            orphanRemoval = true)
    @JsonIgnoreProperties(value = "userprop",
            allowSetters = true)
    private List<UserProperty> userprops = new ArrayList<>();
     ...
     * <p>
     * //     * //     autogenerated* @param username     The username (String) of the user
...
//    }
    ...
    public List<UserProperty> getUserprops() {
        return userprops;
    }

    public void setUserprops(List<UserProperty> userprops) {
