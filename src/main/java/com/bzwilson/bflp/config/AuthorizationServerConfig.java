...
public class AuthorizationServerConfig
     ...
     */
    static final String CLIENT_ID = "clientid";//System.getenv("OAUTHCLIENTID");

    /**
     * Client secret is the password for the client application. It is read from the environment variable OAUTHCLIENTSECRET
     */
    static final String CLIENT_SECRET = "clientsecret"; //System.getenv("OAUTHCLIENTSECRET"); // read from environment variable
