...
public class AuthorizationServerConfig
     ...
     */
    static final String CLIENT_SECRET = System.getenv("OAUTHCLIENTSECRET"); // read from environment variable; //System.getenv("OAUTHCLIENTSECRET"); // read from environment variable
